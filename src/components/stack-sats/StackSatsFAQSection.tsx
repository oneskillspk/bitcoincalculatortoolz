...
const faqs = [
  ...
  { question: "How many sats do I need to stack to own one whole Bitcoin?", answer: "There are exactly 100,000,000 (one hundred million) satoshis in a single Bitcoin. Named after Bitcoin's pseudonymous creator Satoshi Nakamoto, the satoshi is the smallest on-chain unit. This divisibility allows anyone to own meaningful fractions of Bitcoin regardless of its price per coin." },
