...
const faqsEn = [
  ...
  { q: "How is the liquidation price on a Bitcoin-backed loan calculated?", a: "Liquidation price = (Loan Amount ÷ BTC Collateral) ÷ (Liquidation LTV ÷ 100). For example, if you borrow $50,000 against 1 BTC with an 80% liquidation LTV, your liquidation price is $62,500. Bitcoin must drop below this price to trigger liquidation." },
...
const faqsTr = [
  ...
  { q: "Bitcoin kredisinde tasfiye fiyatı nasıl hesaplanır?", a: "Tasfiye fiyatı = (Kredi Tutarı ÷ BTC Teminatı) ÷ (Tasfiye LTV ÷ 100). Örneğin %80 tasfiye LTV'siyle 1 BTC karşılığında 50.000 $ borçlanırsanız tasfiye fiyatınız 62.500 $'dır. Tasfiyeyi tetiklemek için Bitcoin'in bu fiyatın altına düşmesi gerekir." },
