...
export const LumpSumDCAHowItWorksSection = () => {
  ...
  const steps = tr ? [
    ...
    { icon: TrendingUp, title: 'Strateji Karşılaştırması', description: 'Nihai değerleri, ROI yüzdelerini ve risk metriklerini yan yana karşılaştırın.' },
    ...
    { icon: TrendingUp, title: 'Strategy Comparison', description: 'Compare final values, ROI percentages, and risk metrics side by side.' },
  ...
  return (
    <StepGuide
      title={tr ? 'Yatırım Stratejilerini Karşılaştırın' : 'Compare Investment Strategies'}
      lead={tr
