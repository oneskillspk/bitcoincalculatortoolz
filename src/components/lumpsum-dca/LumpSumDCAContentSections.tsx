        ...
        <Card className="border-border/30 bg-card">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">{tr ? 'Toplu Yatırım vs 12 Aylık DCA: Tarihsel Kazanma Oranları' : 'Lump Sum vs 12-Month DCA: Historical Win Rates'}</CardTitle>
                <p className="text-sm text-muted-foreground mt-1">
                  {tr ? 'Her yılın başında yatırılan 10.000 $, 2025 sonuna kadar elde tutuldu' : '$10,000 invested at the start of each year, held until end of 2025'}
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto -mx-6 px-6">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="font-semibold">{tr ? 'Başlangıç Yılı' : 'Start Year'}</TableHead>
                    <TableHead className="font-semibold">{tr ? 'Piyasa Aşaması' : 'Market Phase'}</TableHead>
                    <TableHead className="font-semibold text-right">{tr ? 'Toplu Yatırım Sonuç' : 'Lump Sum Final'}</TableHead>
                    <TableHead className="font-semibold text-right">{tr ? 'DCA Sonuç' : 'DCA Final'}</TableHead>
                    <TableHead className="font-semibold text-right">{tr ? 'Kazanan' : 'Winner'}</TableHead>
                    <TableHead className="font-semibold text-right">{tr ? 'Fark' : 'Edge'}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">2017</TableCell>
                    <TableCell>{tr ? 'Boğa zirvesi başlangıcı' : 'Bull peak start'}</TableCell>
                    <TableCell className="text-right font-mono">$110,000</TableCell>
                    <TableCell className="text-right font-mono">$78,000</TableCell>
                    <TableCell className="text-right text-success font-semibold">Lump Sum</TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{tr ? 'Toparlanma' : 'Recovery'}</TableCell>
                    <TableCell className="text-right font-mono">$181,000</TableCell>
                    <TableCell className="text-right font-mono">$142,000</TableCell>
                    <TableCell className="text-right text-success font-semibold">Lump Sum</TableCell>
                    <TableCell className="text-right">+27%</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">2020</TableCell>
                    <TableCell>{tr ? 'Halving öncesi' : 'Pre-halving'}</TableCell>
                    <TableCell className="text-right font-mono">$148,000</TableCell>
                    <TableCell className="text-right font-mono">$98,000</TableCell>
                    <TableCell className="text-right text-success font-semibold">Lump Sum</TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>{tr ? 'Erken boğa' : 'Early bull'}</TableCell>
                    <TableCell className="text-right font-mono">$62,000</TableCell>
                    <TableCell className="text-right font-mono">$48,000</TableCell>
                    <TableCell className="text-right text-success font-semibold">Lump Sum</TableCell>
                    <TableCell className="text-right">+29%</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">2024</TableCell>
                    <TableCell>{tr ? 'Halving yılı' : 'Halving year'}</TableCell>
                    <TableCell className="text-right font-mono">$24,000</TableCell>
                    <TableCell className="text-right font-mono">$20,500</TableCell>
                    <TableCell className="text-right text-success font-semibold">Lump Sum</TableCell>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mt-4 leading-relaxed max-w-prose">
              {tr
                ? <><strong>Puan: Toplu Yatırım 5, DCA 3.</strong> Toplu yatırım, döngü dibine yakın veya erken boğa piyasalarında başlarken kazanır. DCA ise zirveye yakın (2018, 2021) veya daha düşük fiyatlara ortalama maliyetle girmenin işe yaradığı uzun ayı piyasalarında kazanır.</>
                : <><strong>Score: Lump Sum 5, DCA 3.</strong> Lump sum wins when you start near a cycle bottom or in early bull markets. DCA wins when you start near a peak (2018, 2021) or during prolonged bear markets where averaging into lower prices pays off.</>}
            </p>
          </CardContent>
        </Card>
