      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select value={currency} onValueChange={setCurrency}>
            <SelectTrigger id="currency" aria-label={tr ? 'Para birimi seçin' : 'Select currency'} className="">
              <SelectValue />
            </SelectTrigger>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={dcaFrequency} onValueChange={(value: any) => setDcaFrequency(value)}>
                <SelectTrigger id="dca-frequency" aria-label={tr ? 'Alım sıklığı seçin' : 'Select purchase frequency'} className="">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
