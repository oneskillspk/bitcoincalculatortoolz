    ...
    <Card className="glass-morphism-card border-border/20">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {tr ? 'Stratejiler arasında risk metriklerini ve oynaklığı karşılaştırın' : 'Compare risk metrics and volatility between strategies'}
            </p>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="border-border/20 bg-gradient-to-br from-green-50/20 to-green-100/20">
            <CardContent className="p-4">
              <h4 className="font-semibold text-foreground mb-3 flex items-center gap-2">
          ...
          <Card className="border-border/20 bg-gradient-to-br from-red-50/20 to-red-100/20">
            <CardContent className="p-4">
              <h4 className="font-semibold text-foreground mb-3 flex items-center gap-2">
        ...
        {/* Risk Recommendation */}
        <Card className="border-border/20 bg-gradient-to-r from-primary/5 to-primary/10">
