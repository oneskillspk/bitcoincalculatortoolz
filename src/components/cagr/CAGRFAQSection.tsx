...
const cagrFaqsTr = [
  ...
  { question: "Bitcoin'in 2013'ten bu yana yıllıklandırılmış getirisi nedir?", answer: "Ocak 2013'ten (~13 $) Ocak 2026'ya (~93.000 $) Bitcoin'in yıllıklandırılmış getirisi 13 yıl boyunca yılda yaklaşık %89'dur. Formül: (93.000 / 13)^(1/13) − 1 ≈ 0,89. Bu, her büyük varlık sınıfını 6 kattan fazla geride bırakır ve Bitcoin'in marjinal bir deneyden 1,8T+ dolarlık bir makro varlığa geçişini yansıtır — ancak yıllıklandırılmış rakam, taban büyüdükçe her döngüde sıkışmaktadır." },
];
