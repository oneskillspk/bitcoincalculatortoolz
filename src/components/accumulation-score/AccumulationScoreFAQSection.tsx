...
const faqsEn = [
  ...
  { q: "How does this calculator assign my A+ to F Bitcoin grade?", a: "Your grade is based on the ratio of your actual BTC holdings to the model's target for your age. A+ = 150%+ of target (elite), A = 110–150% (ahead), B+ = 90–110% (on track), B = 75–90% (almost there), C = 50–75% (room to grow), D = 25–50% (getting started), F = below 25% (start stacking)." },
  { q: "What is the lifecycle-model BTC target for an 18-year-old?", a: "According to the Bitcoin Lifecycle Model, an 18-year-old in the 'Young Adult' phase should have approximately 0.102 BTC. At this age, the time advantage is enormous — even small regular purchases compound dramatically over decades." },
  { q: "What is the lifecycle-model BTC target for a 25-year-old?", a: "A 25-year-old in the 'Prime Accumulator' phase has a target of approximately 2.45 BTC. This is the quarter-century mark where career income is growing and the compound time advantage remains very strong." },
  { q: "What is the lifecycle-model BTC target for a 30-year-old?", a: "A 30-year-old in the 'Peak Builder' phase has a target of approximately 13.59 BTC. This is a critical benchmark — income is at career-level, and accumulation velocity should be accelerating toward the 40-year peak." },
  { q: "What is the lifecycle-model BTC target for a 35-year-old?", a: "A 35-year-old should have approximately 47.56 BTC according to the lifecycle model. This is halfway to the peak accumulation target at age 40 (144 BTC) and represents the top earning decade." },
  { q: "What is the lifecycle-model BTC target for a 40-year-old?", a: "Age 40 is the peak of the Bitcoin Lifecycle Model with a target of approximately 144 BTC. This represents maximum lifetime accumulation — the intersection of peak earning power and sufficient time having been in the Bitcoin market." },
  { q: "Can I still earn an A grade if I start Bitcoin at 45 or 50?", a: "Yes. While the lifecycle model shows declining targets after 40 (reflecting natural spending), it's never too late to start. A consistent DCA strategy at any age builds wealth. The key is starting — even small amounts compound over time. Use the DCA Calculator to model your strategy." },
...
const faqsTr = [
  ...
  { q: "Bu hesaplayıcı A+ ile F arasındaki notu nasıl atar?", a: "Notunuz, gerçek BTC varlıklarınızın yaşınız için modelin hedefine oranına dayanır. A+ = hedefin %150+'si (seçkin), A = %110–150 (önde), B+ = %90–110 (yolda), B = %75–90 (neredeyse orada), C = %50–75 (büyüme payı var), D = %25–50 (başlangıç aşaması), F = %25'in altında (biriktirmeye başla)." },
  { q: "18 yaş için yaşam döngüsü modelinin BTC hedefi nedir?", a: "Bitcoin Yaşam Döngüsü Modeline göre, 'Genç Yetişkin' aşamasındaki 18 yaşındaki birinin yaklaşık 0.102 BTC'ye sahip olması beklenir. Bu yaşta zaman avantajı muazzamdır — küçük düzenli alımlar bile onlarca yıl boyunca dramatik şekilde bileşik faiz yapar." },
  { q: "25 yaş için yaşam döngüsü modelinin BTC hedefi nedir?", a: "'Prime Birikim' aşamasındaki 25 yaşındaki birinin hedefi yaklaşık 2.45 BTC'dir. Bu, kariyer gelirinin büyüdüğü ve bileşik zaman avantajının hâlâ çok güçlü olduğu çeyrek yüzyıl dönüm noktasıdır." },
  { q: "30 yaş için yaşam döngüsü modelinin BTC hedefi nedir?", a: "'Zirve Oluşturucu' aşamasındaki 30 yaşındaki birinin hedefi yaklaşık 13.59 BTC'dir. Bu kritik bir kilometre taşıdır — gelir kariyer düzeyindedir ve birikim hızının 40 yaş zirvesine doğru ivme kazanması gerekir." },
  { q: "35 yaş için yaşam döngüsü modelinin BTC hedefi nedir?", a: "Yaşam döngüsü modeline göre 35 yaşındaki birinin yaklaşık 47.56 BTC'ye sahip olması gerekir. Bu, 40 yaşındaki zirve birikim hedefinin (144 BTC) yarısında olup en yüksek kazanç on yılını temsil eder." },
  { q: "40 yaş için yaşam döngüsü modelinin BTC hedefi nedir?", a: "40 yaş, Bitcoin Yaşam Döngüsü Modelinin zirvesidir ve hedef yaklaşık 144 BTC'dir. Bu, maksimum yaşam boyu birikimi temsil eder — zirve kazanç gücü ile Bitcoin piyasasında yeterli süredir bulunmanın kesişimi." },
  { q: "45 veya 50 yaşında başlayarak A notu almak hâlâ mümkün mü?", a: "Evet. Yaşam döngüsü modeli 40'tan sonra azalan hedefler gösterse de (doğal harcamaları yansıtarak) başlamak için hiçbir zaman geç değildir. Herhangi bir yaşta tutarlı bir DCA stratejisi servet inşa eder. Önemli olan başlamaktır — küçük miktarlar bile zamanla bileşik faiz yapar." },
