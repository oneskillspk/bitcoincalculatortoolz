            ...
            <CardContent className="p-0">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow><TableCell className="font-medium">{tr ? 'Ara 2017 zirvesi' : 'Dec 2017 peak'}</TableCell><TableCell>$19,800</TableCell><TableCell>0.00505 BTC</TableCell><TableCell className="text-amber-500">$505</TableCell></TableRow>
                  ...
                  <TableRow><TableCell className="font-medium">{tr ? 'Kas 2021 zirvesi' : 'Nov 2021 peak'}</TableCell><TableCell>$69,000</TableCell><TableCell>0.00145 BTC</TableCell><TableCell className="text-amber-500">$145</TableCell></TableRow>
