            ...
            <CardContent className="p-0">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow data-testid="ath-conversion-row"><TableCell className="font-medium">{tr ? 'Eki 2025 zirvesi' : 'Oct 2025 peak'}</TableCell><TableCell>{athPriceLabel}</TableCell><TableCell>{formatBtcAmount(athRow.btcAmount)} BTC</TableCell><TableCell className="text-warning">{formatWorth(athRow.worthNow)}</TableCell></TableRow>
                </TableBody>
              </Table>
            </CardContent>
          </Card>
          ...
          <div className="text-base text-muted-foreground leading-relaxed space-y-4 max-w-3xl mx-auto">
            {tr ? (
              <>
                ...
                <p>Mekanizma grafiğin göründüğünden daha basittir. Çıkarım düşer, yeni coin üretme maliyeti artar ve daha yavaş büyüyen bir arzın karşısında yeni alıcılardan gelen talep birikir. Dört yarılanmadan üçünün ardından 18 ay içinde yeni bir tüm zamanların en yükseği görüldü. 2024 yarılanması aynı senaryoyu izledi ve Bitcoin Ekim 2025\'te 126.198 $\'da yeni bir rekora ulaştı; ardından 2026\'nın ikinci çeyreğinde yaklaşık 65.000 $\'a döngüsel geri çekilme yaşandı. Bu bir sonraki döngüyü garanti etmez; ancak uzun vadeli Bitcoin yatırımcılarının haftalık mumları okumak yerine neden 4 yıllık bloklar halinde planladığını açıklar.</p>
              </>
            ) : (
              <>
