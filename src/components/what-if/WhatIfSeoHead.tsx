  ...
  const faqSchemaLocalized = useLocalizedSchema(
    null,
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "Bitcoin'e yatırım yapmak için artık geç mi?", "acceptedAnswer": { "@type": "Answer", "text": "Bu soru 100 $, 1.000 $, 10.000 $, 60.000 $ ve 2025'te 122.260 $ zirvesinde sorulmuştur. Her seferinde Bitcoin bir sonraki döngüde daha yüksek dip ve daha yüksek zirveler oluşturdu. Geçmiş performans garanti vermese de uzun vadeli sahiplerin tarihsel olarak ödüllendirildiği görülmektedir." } },
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "What's the worst entry price in Bitcoin history?", "acceptedAnswer": { "@type": "Answer", "text": "The three most painful single-day buys were the December 17, 2017 peak at $19,800, the November 10, 2021 peak at $69,000, and the October 4, 2025 peak at $122,260. The 2017 peak required a 3-year hold to recover. The 2021 peak required roughly 28 months. The 2025 peak remains underwater at the July 2026 reference price of $65,000 and is waiting on the next cycle." } },
