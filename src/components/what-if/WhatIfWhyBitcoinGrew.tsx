          ...
          {tr ? (
            <>
              ...
              <p>
                ...
                adı verilir. Bu programatik arz azalması tarihsel olarak büyük fiyat yükselişlerinin öncüsü olmuştur: 2012 yarılanmasının ardından Bitcoin 12 $'dan 1.000 $'ın üzerine çıktı; 2016 sonrasında neredeyse 20.000 $'a ulaştı; 2020 yarılanmasının ardından ise 69.000 $'ı aştı. En son Nisan 2024 yarılanması blok ödülünü 3,125 BTC'ye düşürdü ve Bitcoin\'i Ekim 2025\'te 122.260 $\'lık yeni bir tüm zamanların en yükseğine taşıyan döngüyü başlattı. Her döngü, "yarılanmadan önce Bitcoin alsaydım ne olurdu" senaryolarını çalıştıran yeni yatırımcıları çekiyor — yukarıdaki hesap makinesi tam olarak bunu test etmenizi sağlıyor.
              </p>
              <p>
            ...
            <>
              ...
              <p>
                ...
                This programmatic supply reduction has historically preceded major price rallies: after the 2012 halving, Bitcoin went from $12 to over $1,000; after 2016, it reached nearly $20,000; and following the 2020 halving, it surpassed $69,000. The most recent April 2024 halving cut the block reward to 3.125 BTC and kicked off the cycle that carried Bitcoin to a fresh all-time high of $122,260 in October 2025. Each cycle attracts new investors who run "what if I bought Bitcoin before the halving" scenarios — and the calculator above lets you test exactly that.
              </p>
              <p>
