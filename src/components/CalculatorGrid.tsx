          ...
          <div className="max-w-2xl mx-auto mb-10 space-y-5">
            ...
            <div className="text-center">
              ...
              <p className="text-base text-muted-foreground max-w-xl mx-auto leading-relaxed">
                {language === 'tr' ? 'DCA, emeklilik planlaması, vergi tahmini ve portföy optimizasyonu için 45+ ücretsiz araç.' : 'Explore 45+ free tools for DCA, retirement planning, tax estimation, and portfolio optimization'}
              </p>
            </div>
