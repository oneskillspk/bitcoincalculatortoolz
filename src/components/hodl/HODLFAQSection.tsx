...
tr: [
  ...
  { question: 'Derin bir Bitcoin ayı piyasasında tutmaya devam etmeli miyim?', answer: '%50 düşüş normal — Bitcoin, 2013’ten beri her 12-18 ayda bir 50%+ drawdown yaşadı ve toparlandı. Öncelikle acil fonunuzun 3-6 ay giderinizi karşıladığını doğrulayın; sağlamsa DCA’nızı sürdürün ve pozisyon boyutunuzu %10-20 artırmayı düşünün. Panikle satmayın; Kasım 2022 dibinde satanlar 12 ay içinde 2× getiri kaçırdı.' },
...
en: [
  ...
  { question: 'What should I do if bitcoin crashes?', answer: 'Direct answer: don\'t sell, automate your buying plan, and add to your position if your finances can handle it. Every historical Bitcoin crash (2011, 2013, 2018, 2022) was followed by a cycle that surpassed the prior all-time high. The people who lost money were the ones who sold at the worst point. Only hold what you can leave for 5+ years, and keep automated DCA running through the drawdown.' },
  { question: 'Should I keep holding through a deep bitcoin bear market?', answer: 'A 50% drawdown is normal — Bitcoin has experienced a 50%+ pullback roughly every 12-18 months since 2013 and recovered every time. First confirm your emergency fund still covers 3-6 months of expenses; if yes, keep DCA running and consider increasing position size by 10-20%. Do not panic sell — investors who sold at the November 2022 bottom missed a 2× recovery within 12 months.' },
  { question: 'What should I do if bitcoin hits a new all-time high?', answer: 'Don\'t auto-sell at ATH. Every Bitcoin ATH in history has been surpassed by 2-10× in a subsequent cycle. Rational framework: (1) rebalance any position that has grown past 10-20% of net worth, (2) take partial profits into stablecoins or diversifiers rather than going fully to cash, (3) keep a long-term core position. Prioritize selling lots held over 1 year to reduce tax impact.' }
]
