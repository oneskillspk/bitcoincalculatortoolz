...
en: [
  ...
  { question: 'What should I do if bitcoin drops 50%?', answer: 'A 50% drawdown is normal — Bitcoin has experienced a 50%+ pullback roughly every 12-18 months since 2013 and recovered every time. First confirm your emergency fund still covers 3-6 months of expenses; if yes, keep DCA running and consider increasing position size by 10-20%. Do not panic sell — investors who sold at the November 2022 bottom missed a 2× recovery within 12 months.' },
