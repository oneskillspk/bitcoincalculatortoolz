...
const allCalculators = [
  ...
  { id: "bitcoin-tax-india", path: "/calculators/bitcoin-tax-india", title: "Bitcoin Tax — India", titleTr: "Bitcoin Vergi — Hindistan", description: "India §115BBH: flat 30% on Bitcoin gains + 4% cess + 1% TDS on proceeds", descriptionTr: "Hindistan §115BBH: Bitcoin kazancında sabit %30 + %4 cess + %1 TDS", icon: FileText, color: "border-amber-500/20 hover:border-amber-500/40", iconBg: "bg-amber-500/10", iconColor: "text-amber-500", related: ["bitcoin-tax-uk-cgt", "bitcoin-tax-germany", "capital-gains-tax", "profit-loss", "bitcoin-zakat", "inheritance-tax"] },
  { id: "bitcoin-tax-uk-cgt", path: "/calculators/bitcoin-tax-uk-cgt", title: "Bitcoin CGT — UK", titleTr: "Bitcoin CGT — İngiltere", description: "UK 2025/26: £3,000 allowance, 18% basic / 24% higher CGT rate", descriptionTr: "İngiltere 2025/26: £3.000 muafiyet, %18 temel / %24 üst CGT oranı", icon: FileText, color: "border-primary/20 hover:border-primary/40", iconBg: "bg-primary/10", iconColor: "text-primary", related: ["bitcoin-tax-india", "bitcoin-tax-germany", "capital-gains-tax", "inheritance-tax", "profit-loss", "average-buy-price"] },
  { id: "bitcoin-tax-germany", path: "/calculators/bitcoin-tax-germany", title: "Bitcoin Tax — Germany", titleTr: "Bitcoin Vergi — Almanya", description: "§23 EStG: 0% after 12 months, marginal rate within 12 months, €1,000 Freigrenze", descriptionTr: "§23 EStG: 12 ay sonra %0, 12 ay içinde marjinal oran, €1.000 Freigrenze", icon: FileText, color: "border-success/20 hover:border-success/40", iconBg: "bg-success/10", iconColor: "text-success", related: ["bitcoin-tax-uk-cgt", "bitcoin-tax-india", "capital-gains-tax", "hodl-strategy", "retirement", "inheritance-tax"] },
];
