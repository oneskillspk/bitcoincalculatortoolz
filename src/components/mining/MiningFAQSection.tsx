...
const faqsTr = [
  ...
  { question: "Sonuçlarda gösterilen başabaş BTC fiyatı nedir?", answer: "Günlük madencilik gelirinizin günlük elektriği tam olarak karşıladığı BTC spot fiyatıdır (havuz ücreti önceden düşülmüştür): başabaş fiyat = günlük elektrik maliyeti ÷ günlük çıkarılan BTC. Bu fiyatın altında, donanım geri ödemesini hesaba katmadan bile her gün yalnızca elektrik nedeniyle zarar edersiniz. Sonuç kartı bu değeri, farklı bir soruyu yanıtlayan Donanım Geri Ödeme ile birlikte gösterir — yani günlük kârın donanım maliyetini kaç günde geri kazanacağını." },
];
