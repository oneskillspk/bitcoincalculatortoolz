...
const COMPARISON_ITEMS: ComparisonItem[] = [
  ...
  { nameEn: 'Hotel Nights', nameTr: 'Otel Gecesi', icon: Crown, priceUSD: 200, categoryEn: 'Experience', categoryTr: 'Deneyim', color: 'bg-warning/$3 text-warning' },
  ...
  { nameEn: 'Coffee Orders', nameTr: 'Kahve', icon: Coffee, priceUSD: 5, categoryEn: 'Lifestyle', categoryTr: 'Yaşam Tarzı', color: 'bg-warning/$3 text-warning' },
  ...
  { nameEn: 'Jewelry', nameTr: 'Mücevher', icon: Gift, priceUSD: 1500, categoryEn: 'Luxury', categoryTr: 'Lüks', color: 'bg-destructive/$3 text-destructive' },
  ...
  { nameEn: 'Gold Ounces', nameTr: 'Ons Altın', icon: Coins, priceUSD: 2000, categoryEn: 'Investment', categoryTr: 'Yatırım', color: 'bg-yellow-400/10 text-warning' },
