...
const build = (px: number) => {
  ...
  return [
    ...
    { question: 'How is liquidation price calculated for a given lot size?', answer: `Long liquidation ≈ Entry × (1 − 1/Leverage + Maintenance Margin %). Short flips the sign. At 10× with 0.5% maint. margin, a $${p} long liquidates near $${(px * 0.905).toFixed(0)}. Our Liquidation & Cost card computes it live.` },
