          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "How do I know if my Bitcoin stack is enough to retire?", "acceptedAnswer": { "@type": "Answer", "text": "Multiply your annual expenses by 25 (the 4% safe-withdrawal number), then divide by your BTC holdings — that is the BTC price at which your stack covers retirement. Example: $50,000 × 25 = $1.25M; hold 2 BTC and you retire once BTC hits $625,000. Run FIRE Mode with your real numbers for a year-by-year timeline." } }
              ]
            })}
          </script>
        )}
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "mainEntity": [
                ...
                { "@type": "Question", "name": "Bitcoin yığınımın emekliliğe yetip yetmeyeceğini nasıl anlarım?", "acceptedAnswer": { "@type": "Answer", "text": "Yıllık giderlerinizi 25 ile çarpın (%4 çekim kuralı), sonucu tuttuğunuz BTC miktarına bölün — çıkan rakam, yığınınızın emekliliği karşıladığı BTC fiyatıdır. Örnek: yılda 500.000 ₺ × 25 = 12,5 milyon ₺; 2 BTC tutuyorsanız BTC 6,25 milyon ₺'ye ulaştığında emekli olursunuz. FIRE Modu'nu kendi sayılarınızla çalıştırın." } }
              ]
            })}
          </script>
        )}
