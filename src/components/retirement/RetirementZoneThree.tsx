...
/**
 * Zone 3 — Editorial / How It Works. Rendered as a fragment so each child
 * section owns its own vertical rhythm (shared via SECTION_Y) without an
 * outer PageSection adding a second layer of padding.
 */
export const RetirementZoneThree = ({ language, onSelectMode }: Props) => (
  <>
    <section className={SECTION_Y}>
      <div className={`${SECTION_CONTAINER} max-w-3xl text-center`}>
