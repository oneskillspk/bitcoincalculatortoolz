/**
 * Unified section header for the retirement page.
 * Pattern: centered eyebrow pill (text-only, no icon) + centered H2 + optional centered lead.
 * Matches the FAQ-style header rhythm used across Zones 2/3/4.
 */
