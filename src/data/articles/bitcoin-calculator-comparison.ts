...
const article: Article = {
  ...
  faqs: [
    { question: 'Which is the best free Bitcoin calculator?', answer: 'Bitcoin Calculator Tools offers the widest range of free calculators (46+) with no signup required. Exchange calculators like Binance and Coinbase offer 1–3 basic tools tied to their trading platforms.' },
