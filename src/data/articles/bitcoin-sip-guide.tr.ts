...
const article: Article = {
  ...
  faqs: [
    { question: 'Bitcoin SIP nedir ve nasıl çalışır?', answer: 'Bitcoin SIP (Sistematik Yatırım Planı), fiyat oynaklığının etkisini azaltmak ve zamanla servet oluşturmak için Bitcoin\'e düzenli aralıklarla — haftalık, iki haftalık veya aylık — sabit bir miktar yatırdığınız bir stratejidir. Hindistan ve Asya\'da popüler olan yatırım fonu SIP\'lerinin kripto eşdeğeridir.' },
