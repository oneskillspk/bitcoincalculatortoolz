...
const article: Article = {
  ...
  title: 'Bitcoin Lot Size: Formula, Contract Specs and Broker Table',
  metaDescription: '1 standard BTCUSD lot = 1 BTC. Lot size = risk $ ÷ stop distance. Contract specs and min lots for Exness, IC Markets, Binance, Bybit — plus BTCXAU sizing.',
