...
const article: Article = {
  ...
  relatedArticles: ['bitcoin-hesaplayici-karsilastirma', 'bitcoin-soguk-cuzdan-rehberi', 'bitcoin-seed-phrase-yedekleme'],
