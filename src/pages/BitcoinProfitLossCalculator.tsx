      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "How do I calculate my Bitcoin cost basis for taxes?", "acceptedAnswer": { "@type": "Answer", "text": "For US tax purposes, cost basis is every dollar you paid to acquire that BTC — buy price + exchange buy fee + network fees on transfers to your own wallet. Track each lot separately since Form 8949 asks for acquisition dates. When you sell, the IRS lets you use FIFO, specific-lot, or HIFO accounting as long as you stay consistent within the year." }},
            { "@type": "Question", "name": "How do I calculate Bitcoin losses for a tax write-off?", "acceptedAnswer": { "@type": "Answer", "text": "Loss = Cost Basis − Net Sale Proceeds (after sell fees). In the US you can use that loss to first offset capital gains, then deduct up to $3,000 per year against ordinary income and carry the rest forward. The 30-day wash-sale rule does not currently apply to crypto in the US as of 2025, but always check the latest IRS guidance before filing." }},
            { "@type": "Question", "name": "How do I read a Bitcoin ROI chart?", "acceptedAnswer": { "@type": "Answer", "text": "The horizontal axis shows time and the vertical axis shows percent return versus your average entry price. The zero line is break-even after fees. Any point above zero means you are in profit, below means down. The ROI line uses the after-fee net figure, so the displayed profit is what would actually land in your account." }}
          ]
        })}</script>
        </>}
        ...
        {language === 'tr' && <>
          ...
          <script type="application/ld+json">{JSON.stringify({
            ...
            "mainEntity": [
              ...
              {"@type": "Question", "name": "Vergi için Bitcoin maliyet bazımı nasıl hesaplarım?", "acceptedAnswer": {"@type": "Answer", "text": "ABD vergi amaçlarıyla maliyet bazınız, o BTC'yi edinmek için ödediğiniz her doları (alış fiyatı + borsa alım ücreti + kendi cüzdanınıza gönderdiğiniz ağ ücretleri) içerir. Her lotu ayrı takip edin; Form 8949 satın alma tarihini ister. IRS FIFO, spesifik-lot ve HIFO seçmenize izin verir; yıl içinde tutarlı olmanız gerekir."}},
              {"@type": "Question", "name": "Vergi indirimi için Bitcoin zararını nasıl hesaplarım?", "acceptedAnswer": {"@type": "Answer", "text": "Zarar = Maliyet Bazı − Net Satış Geliri (satım ücretleri sonrası). ABD'de bu zararı önce sermaye kazançlarını netlemek için kullanabilir, sonra yılda 3.000 $'a kadar olağan gelirden düşebilir ve kalanı ileri taşıyabilirsiniz. 'Wash-sale' kuralı 2025 itibarıyla ABD'de kripto için geçerli değildir; ancak durum değişebilir."}},
              {"@type": "Question", "name": "Bitcoin ROI grafiği nasıl okunur?", "acceptedAnswer": {"@type": "Answer", "text": "Yatay eksen zamanı, dikey eksen ortalama giriş fiyatınıza göre yüzde getiriyi gösterir. Sıfır çizgisi ücretler sonrası başabaştır. Üstündeki her nokta kârda, altındaki her nokta zararda olduğunuzu gösterir. Yukarıdaki ROI çizgisi ücret sonrası net rakamı kullanır."}}
            ]
          })}</script>
        </>}
