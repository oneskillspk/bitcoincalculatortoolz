      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "How do I track cost basis across multiple Bitcoin buys on this calculator?", "acceptedAnswer": { "@type": "Answer", "text": "Add each buy as a separate lot in the calculator — enter the buy date, price, amount, and fee. The tool computes a weighted average cost basis and shows per-lot P/L, so you can see which purchases are green and which are underwater without leaving the page. For filing your taxes, use the dedicated Bitcoin Capital Gains Tax Calculator." }},
        ...
        {language === 'tr' && <>
          ...
          <script type="application/ld+json">{JSON.stringify({
            ...
            "mainEntity": [
              ...
              {"@type": "Question", "name": "Bu hesaplayıcıda birden fazla Bitcoin alımı için maliyet bazını nasıl takip ederim?", "acceptedAnswer": {"@type": "Answer", "text": "Her alımı ayrı bir lot olarak ekleyin — tarih, fiyat, miktar ve ücreti girin. Araç ağırlıklı ortalama maliyet bazını hesaplar ve her lot için kâr/zararı gösterir; hangi alımların yeşilde hangilerinin kırmızıda olduğunu tek ekranda görürsünüz. Vergi beyanı için Bitcoin Sermaye Kazancı Vergisi Hesaplayıcısı'nı kullanın."}},
