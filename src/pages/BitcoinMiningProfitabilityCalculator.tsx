  ...
  const faqSchema = useLocalizedSchema(
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "How long to break even on an Antminer S21?", "acceptedAnswer": { "@type": "Answer", "text": "At $0.08/kWh and $84,000 BTC price, the S21 (200 TH/s, $5,500) breaks even in roughly 8-12 months assuming 3.5% monthly difficulty growth." } },
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "Antminer S21'de başabaş ne kadar sürer?", "acceptedAnswer": { "@type": "Answer", "text": "0,08 $/kWh ve 84.000 $ BTC fiyatında S21 (200 TH/s, 5.500 $) aylık %3,5 zorluk artışı varsayımıyla yaklaşık 8-12 ayda başabaşa ulaşır." } },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image:alt" content={(typeof window !== 'undefined' && window.location.pathname.startsWith('/tr')) ? 'Bitcoin Hesaplayıcıları — 45+ Ücretsiz Araç | bitcoincalculator.tools' : 'Bitcoin Mining Profitability Calculator | bitcoincalculator.tools'} />
