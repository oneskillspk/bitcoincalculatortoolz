  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image:alt" content={(typeof window !== 'undefined' && window.location.pathname.startsWith('/tr')) ? 'Bitcoin Hesaplayıcıları — 45+ Ücretsiz Araç | bitcoincalculator.tools' : 'Bitcoin Volatility Calculator | bitcoincalculator.tools'} />
      ...
      <PageBackground variant="clean">
        ...
        <main id="main-content" className="pt-20 relative z-10">
            ...
            <div className="max-w-6xl mx-auto space-y-10">
              ...
              {isError && (
                <div className="flex items-center gap-3 bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
                  ...
                  <p className="text-sm text-amber-600">{t('vol.error.fetch')}</p>
                </div>
              )}
          ...
          <div className="container mx-auto px-6 max-w-5xl"><AffiliatePlacement slug="volatility" /></div>
          <RelatedCalculators />
