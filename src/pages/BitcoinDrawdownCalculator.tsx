        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": (language === 'tr' ? [
              ...
              { q: "Bitcoin %50 düşerse ne yapmalıyım?", a: "Doğrudan cevap: panikle satmayın, acil fonunuzun 3-6 ay giderinizi karşıladığını doğrulayın ve otomatik DCA'nızı sürdürün. ATH'den %50+ düşüş Bitcoin tarihinde her 12-18 ayda bir yaşanır ve her biri toparlandı. Pozisyon boyutunuz doğruysa (net değerin %5-25'i) %50 düşüş rahatsız edicidir ama portföyü bitirmez. Acil fon dışında nakit varsa pozisyonu %10-20 artırmayı düşünün." },
              { q: "Bitcoin %30 düşerse ne yapmalıyım?", a: "%30 geri çekilme normal bir döngü ortası düzeltmesidir — Bitcoin, boğa piyasası başına 3-5 böyle düşüş ortalamalar. Yatırım tezinizi değiştirmediyseniz otomatik alımınız çalışmaya devam etsin. Nakdiniz varsa ATH'den %30 düşüş, uzun vadeli pozisyona eklemek için tarihsel olarak makul bir giriş noktasıdır. %30 düşüşte satmak, tamamlanmış her Bitcoin döngüsünde 12 ay içinde kaybettiren bir hareket olmuştur." },
            ] : [
              ...
              { q: "What should I do if bitcoin drops 50%?", a: "Direct answer: don't sell in panic, verify your emergency fund covers 3-6 months of expenses, and continue automated DCA. A 50%+ drawdown from ATH has happened roughly every 12-18 months in Bitcoin's history and every one has recovered. If your position sizing was correct (5-25% of net worth), a 50% drop is uncomfortable but not portfolio-ending. Consider a modest 10-20% position increase if you have available cash outside your emergency fund." },
              { q: "What should I do if bitcoin drops 30%?", a: "A 30% pullback is a normal mid-cycle correction — Bitcoin has averaged 3-5 such drawdowns per bull market. If your thesis hasn't changed, do nothing except keep your automated buying running. If you have dry powder, a 30% drawdown from ATH is historically a reasonable entry point for adding to a long-term position. Selling into a 30% drop has, in every completed Bitcoin cycle, been a losing move within 12 months." },
            ]).map((f) => ({
              "@type": "Question",
              "name": f.q,
