...
export const AFFILIATES: AffiliateProgram[] = [
  ...
  },
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Own your keys — Trezor",
    cta_short_tr: "Anahtarlarına sahip ol — Trezor",
  ...
  },
  {
    ...
    cta_short_en: "File crypto taxes in 20 min",
    cta_short_tr: "Kripto vergini 20 dakikada hazırla",
  ...
  // --- Below: in registry, not yet enabled. Flip in admin when ready. ---
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Trade BTC on Kraken",
    cta_short_tr: "Kraken'de BTC işlem yap",
  ...
  },
  {
    ...
    cta_short_en: "Start buying Bitcoin in minutes",
    cta_short_tr: "Dakikalar içinde Bitcoin almaya başlayın",
  ...
  },
  {
    ...
    cta_short_en: "Sign up on MEXC",
    cta_short_tr: "MEXC'te hesap aç",
    ...
    badge_en: "Up to 8,000 USDT",
    badge_tr: "8.000 USDT'ye kadar",
    logo_color: "#1972f5",
    target_pages: [
  ...
  },
  {
    ...
    cta_short_en: "Claim Bybit bonus",
    cta_short_tr: "Bybit bonusunu al",
    cta_long_en: "Trade BTC with deposit rewards on Bybit",
    cta_long_tr: "Yatırım ödülleriyle BTC işlemi yap",
    description_en: "Pro trading platform with deep liquidity. New users earn up to $30,000 in bonuses.",
    description_tr: "Derin likiditeye sahip profesyonel platform. Yeni kullanıcılara yatırım ödülleri sunar.",
    badge_en: "Up to $30,000 bonus",
    badge_tr: "30.000$'a kadar bonus",
    logo_color: "#f7a600",
    target_pages: [
  ...
  },
  {
    ...
    cta_short_en: "Chart BTC like a pro",
    cta_short_tr: "BTC'yi profesyonel gibi analiz et",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    cta_short_en: "Claim your $5 + Visa card",
