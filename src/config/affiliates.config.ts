...
export const AFFILIATES: AffiliateProgram[] = [
  ...
  },
  {
    ...
    cta_long_tr: "Coinbase'de $50 kripto alın, $200 ödül kazanın",
  ...
  },
  {
    ...
    description_en: "Trusted by 10M+ users. Daily payouts and 1,400+ tradable coins.",
    description_tr: "10M+ kullanıcı tarafından tercih edilen borsa. Günlük USDT ödemesi, 1.400+ coin.",
    badge_en: "8,000 USDT bonus",
    badge_tr: "8.000 USDT bonus",
    logo_color: "#1972f5",
    target_pages: [
