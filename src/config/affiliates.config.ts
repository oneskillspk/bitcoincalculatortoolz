...
export const AFFILIATES: AffiliateProgram[] = [
  ...
  },
  {
    ...
    priority: 8,
    enabled: true,
    url_en: "https://promote.mexc.com/b/0qEuh6O2",
    url_tr: "https://promote.mexc.com/b/0qEuh6O2",
    cta_short_en: "Trade on MEXC →",
    cta_short_tr: "MEXC'te İşlem Yap →",
    cta_long_en: "Buy and trade Bitcoin on MEXC — up to 70% fee rebate →",
    cta_long_tr: "MEXC'te Bitcoin al ve işlem yap →",
    description_en: "Highest commission exchange. Daily USDT payouts. Low fees.",
    description_tr: "En yüksek komisyon. Günlük USDT ödemesi. Düşük ücretler.",
    badge_en: "Up to 70% Commission",
    badge_tr: "%70'e Kadar Komisyon",
    logo_color: "#1972f5",
    target_pages: [
