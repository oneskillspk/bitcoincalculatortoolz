...
export const AFFILIATES: AffiliateProgram[] = [
  ...
  },
  {
    ...
    cta_short_en: "Earn up to $200 in crypto",
    cta_short_tr: "Coinbase'de $200'a kadar kazanın",
    cta_long_en: "Buy $50 in crypto on Coinbase and earn up to $200 in rewards",
    cta_long_tr: "Coinbase'de $50 kripto alın, $200'a kadar ödül kazanın",
  ...
  },
  {
    ...
    cta_long_en: "Trade BTC with up to $30,000 in deposit rewards →",
    cta_long_tr: "30.000$'a kadar yatırım ödülüyle BTC işlemi yap →",
    description_en: "Pro trading platform with deep liquidity. New users earn up to $30,000 in bonuses.",
    description_tr: "Derin likiditeye sahip profesyonel platform. Yeni kullanıcılar 30.000$'a kadar bonus kazanır.",
