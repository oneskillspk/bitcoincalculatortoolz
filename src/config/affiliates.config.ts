...
export const AFFILIATES: AffiliateProgram[] = [
  {
    ...
    cta_short_en: "Keep your BTC off exchanges",
    cta_short_tr: "BTC'ni borsadan çıkar",
    cta_variants: {
      "high-value": { en: "Secure your stack from $79", tr: "Yığınını 79$'dan güvene al" },
      "long-term": { en: "Store your BTC for decades", tr: "BTC'ni yıllarca güvende tut" },
    },
    reassurance_en: "6M+ devices sold • from $79",
    reassurance_tr: "6M+ cihaz satıldı • 79$'dan",
    ...
    badge_en: "Most trusted • 6M+ users",
    badge_tr: "En güvenilir • 6M+ kullanıcı",
    logo_color: "#000000",
  ...
  },
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Hold your own keys",
    cta_short_tr: "Anahtarların sende kalsın",
    reassurance_en: "Open source • audited since 2013",
    reassurance_tr: "Açık kaynak • 2013'ten beri denetli",
    cta_long_en: "Open-source cold storage trusted since 2013",
    cta_long_tr: "2013'ten beri güvenilen açık kaynak soğuk cüzdan",
    description_en: "Open-source, fully audited firmware. Not your keys, not your coins.",
    description_tr: "Açık kaynak, tam denetlenmiş yazılım. Anahtarın yoksa, coin'in de yok.",
    badge_en: "Open source • Audited",
    badge_tr: "Açık kaynak • Denetlenmiş",
    logo_color: "#1a1a1a",
  ...
  },
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Automate your weekly buy",
    reassurance_en: "Bitcoin-only • cancel anytime",
    cta_short_tr: null,
    cta_long_en: "Automate your Bitcoin DCA with Swan",
    cta_long_tr: null,
    description_en: "DCA platform built for long-term Bitcoin stackers.",
    description_tr: null,
  ...
  },
  {
    ...
    cta_short_en: "Finish your taxes in 20 min",
    cta_short_tr: "Vergini 20 dakikada bitir",
    cta_variants: {
      tax: { en: "Get your tax report ready", tr: "Vergi raporunu hazırla" },
    },
    reassurance_en: "Free to preview • pay only to download",
    reassurance_tr: "Önizleme ücretsiz • sadece indirirken öde",
    cta_long_en: "Auto-import every trade and download IRS / HMRC-ready reports",
    cta_long_tr: "Tüm işlemleri otomatik al, vergi dairesine hazır rapor indir",
    description_en: "Trusted by 1M+ investors. Reports for 20+ countries, 800+ exchanges, free preview.",
    description_tr: "1M+ yatırımcının tercihi. 20+ ülke, 800+ borsa desteği, ücretsiz önizleme.",
    logo_color: "#7c3aed",
  ...
  },
  {
    ...
    url_tr: null,
    cta_short_en: null,
    cta_short_tr: "TL ile BTC almaya başla",
    reassurance_tr: "Türkiye'nin köklü borsası • TL ile yatırım",
    cta_long_en: null,
  ...
  // --- Below: in registry, not yet enabled. Flip in admin when ready. ---
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Trade BTC at 0.16% fees",
    cta_short_tr: "%0.16 komisyonla BTC al",
    reassurance_en: "Regulated exchange since 2011",
    reassurance_tr: "2011'den beri regüle borsa",
    cta_long_en: "Pro-grade Bitcoin exchange — fees from 0.16%, regulated since 2011",
    cta_long_tr: "Profesyonel Bitcoin borsası — %0.16'dan komisyon, 2011'den beri regüle",
    description_en: "Battle-tested through every crypto cycle. 200+ assets, deep liquidity.",
    description_tr: "Her kripto döngüsünden geçen güvenilir borsa. 200+ varlık, derin likidite.",
    logo_color: "#5848d6",
  ...
  },
  {
    ...
    cta_short_en: "Get up to $200 in crypto",
    cta_short_tr: "$200'e kadar kripto kazan",
    cta_variants: {
      beginner: { en: "Buy your first $50 of BTC", tr: "İlk 50$'lık BTC'ni al" },
    },
    reassurance_en: "Publicly traded • 100M+ users",
    reassurance_tr: "Halka açık şirket • 100M+ kullanıcı",
    cta_long_en: "Buy $50 in crypto on Coinbase and unlock $200 in rewards",
    cta_long_tr: "Coinbase'de $50 kripto alın, $200'e kadar ödül kazanın",
    ...
    badge_en: "New user offer",
    badge_tr: "Yeni kullanıcı fırsatı",
    logo_color: "#0052ff",
    target_pages: ["*"],
    target_results: ["*"],
    language_restriction: [],
    ...
    creative_html: `<a rel="sponsored" href="https://coinbase-consumer.sjv.io/c/7283174/3383210/9251" target="_blank">Earn up to $200 when you buy $50 in crypto. Terms apply.</a>`,
  },
  {
    id: "mexc",
    name: "MEXC",
    ...
    // MEXC's welcome pool is a capped, tiered futures/deposit bonus — never a
    // guaranteed payout. Copy must stay qualified ("up to" / "kadar").
    cta_short_en: "Unlock up to 8,000 USDT",
    cta_short_tr: "8.000 USDT'ye kadar kazan",
    reassurance_en: "10M+ users • 1,400+ coins",
    reassurance_tr: "10M+ kullanıcı • 1.400+ coin",
    cta_long_en: "Sign up with code mexc-Btccalctool for the lowest trading fees",
    cta_long_tr: "mexc-Btccalctool koduyla kayıt ol, en düşük işlem ücretlerinden yararlan",
    description_en: "Trusted by 10M+ users, with 1,400+ tradable coins and a tiered new-user reward pool.",
    description_tr: "10M+ kullanıcının tercihi. 1.400+ coin ve kademeli yeni kullanıcı ödül havuzu.",
    badge_en: "Welcome rewards",
    badge_tr: "Hoş geldin ödülleri",
    logo_color: "#1972f5",
    target_pages: [
  ...
  },
  {
    ...
    url_tr: null,
    cta_short_en: null,
    cta_short_tr: "TL ile ilk BTC'ni al",
    reassurance_tr: "Türkiye'nin popüler platformu",
    cta_long_en: null,
  ...
  },
  {
    ...
    cta_short_en: "Claim your deposit bonus",
    cta_short_tr: "Yatırım bonusunu al",
    cta_variants: {
      "high-risk": { en: "Trade with a bonus buffer", tr: "Bonus tamponuyla işlem yap" },
    },
    reassurance_en: "Deposit rewards • no cost to open",
    reassurance_tr: "Yatırım ödülleri • hesap açmak ücretsiz",
    cta_long_en: "Trade BTC with deposit rewards on Bybit",
    cta_long_tr: "Yatırım ödülleriyle BTC işlemi yap",
    description_en: "Pro trading platform with deep liquidity and a tiered deposit reward pool for new users.",
    description_tr: "Derin likiditeye sahip profesyonel platform. Yeni kullanıcılara yatırım ödülleri sunar.",
    badge_en: "Up to $30,000",
    badge_tr: "30.000$'a kadar",
    logo_color: "#f7a600",
    target_pages: [
  ...
  },
  {
    ...
    cta_short_en: "Chart BTC free",
    cta_short_tr: "BTC grafiklerini ücretsiz aç",
    reassurance_en: "Free plan • no card needed",
    reassurance_tr: "Ücretsiz plan • kart gerekmez",
    cta_long_en: "100+ indicators, real-time BTC charts — free to start",
    cta_long_tr: "100+ gösterge, gerçek zamanlı BTC grafikleri — ücretsiz başla",
    description_en: "Used by 60M+ traders. Real-time charts, alerts, and 100+ indicators.",
    description_tr: "60M+ trader'ın tercihi. Gerçek zamanlı grafikler, uyarılar ve 100+ gösterge.",
    logo_color: "#2962ff",
    target_pages: ["*"],
    target_results: ["*"],
    language_restriction: [],
  ...
  },
  {
    ...
    url_en: null,
    url_tr: null,
    cta_short_en: "Sort your crypto taxes free",
    cta_variants: {
      tax: { en: "Import trades, get your report" },
    },
    reassurance_en: "Import free • pay only at download",
    cta_short_tr: null,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    cta_short_en: "Get $5 + your Visa card",
    cta_short_tr: "5$ + Visa kartını al",
    reassurance_en: "No bank account required",
    reassurance_tr: "Banka hesabı gerekmez",
    cta_long_en: "Spend BTC anywhere Visa is accepted — $5 free on sign-up",
    cta_long_tr: "Visa kabul eden her yerde BTC harca — kayıtta 5$ hediye",
    description_en: "Pay rent, Netflix, X Premium with BTC. Apple Pay + Google Pay. No bank required.",
    description_tr: "Kira, Netflix, X Premium'u BTC ile öde. Apple Pay + Google Pay. Banka gerekmez.",
    badge_en: "$5 sign-up bonus",
    badge_tr: "5$ kayıt bonusu",
    logo_color: "#FF2C5B",
    target_pages: [
      "*",
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    cta_short_en: "Trade BTC CFDs on MT4/MT5",
    cta_short_tr: "MT4/MT5'te BTC CFD işlem yap",
    cta_variants: {
      "high-risk": { en: "Size your trade with micro lots", tr: "Mikro lotla pozisyon aç" },
      leverage: { en: "Trade micro lots, tight spreads", tr: "Mikro lot, dar spread" },
    },
    reassurance_en: "Regulated broker • losses can exceed deposits",
    reassurance_tr: "Regüle broker • kayıplar yatırımı aşabilir",
    ...
    badge_en: "Regulated • MT4/MT5",
    badge_tr: "Regüle • MT4/MT5",
    logo_color: "#E63946",
