...
const ZONE_SIZE_PREFERENCE: Record<Zone, Record<Device, string[]>> = {
  "post-result": {
    desktop: ["728x90", "960x150", "468x60", "336x280", "300x250", "1200x628"],
    tablet: ["468x60", "728x90", "960x150", "300x250", "336x280"],
  ...
  sidebar: {
    desktop: ["300x250", "336x280", "900x750", "160x600", "120x600", "250x250"],
  ...
  inline: {
    desktop: ["728x90", "960x150", "1200x628", "468x60"],
    tablet: ["468x60", "960x150", "300x250"],
    mobile: ["300x250", "320x50"],
  },
  comparison: {
    desktop: ["300x250", "336x280", "1080x1080", "900x750"],
    tablet: ["300x250"],
    mobile: ["300x250", "1080x1080"],
  },
  footer: {
    desktop: ["1920x237", "970x90", "728x90", "960x150", "468x60"],
    tablet: ["728x90", "960x150", "468x60"],
