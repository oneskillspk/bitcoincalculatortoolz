...
const link = { color: '#b54d08', textDecoration: 'underline' }
const button = { backgroundColor: '#b54d08', color: '#ffffff', fontSize: '14px', borderRadius: '12px', padding: '12px 20px', textDecoration: 'none' }
